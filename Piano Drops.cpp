...
void text_blocks()
{
    ...
    renderBitmapString(425, 820, GLUT_BITMAP_TIMES_ROMAN_24, "Thapar University");
    renderBitmapString(348, 780, GLUT_BITMAP_TIMES_ROMAN_24, "Department of Computer Science");
    renderBitmapString(490, 750, GLUT_BITMAP_TIMES_ROMAN_24, "And");
    renderBitmapString(450, 720, GLUT_BITMAP_TIMES_ROMAN_24, "Engineering");
    glColor3f(1.0, 0.0784, 0.5764);
    renderBitmapString(440, 670, GLUT_BITMAP_TIMES_ROMAN_24, "\"Piano Drops\"");
    renderBitmapString(454, 640, GLUT_BITMAP_TIMES_ROMAN_24, "Lab Project");

    glColor3f(0.0, 0.0, 0.0);
    renderBitmapString(360, 200, GLUT_BITMAP_TIMES_ROMAN_24, "Made By:");
    renderBitmapString(360, 170, GLUT_BITMAP_TIMES_ROMAN_24, "Ekalavya Gandotra");
    renderBitmapString(560, 170, GLUT_BITMAP_TIMES_ROMAN_24, "101983049");
    renderBitmapString(360, 140, GLUT_BITMAP_TIMES_ROMAN_24, "Paras");
    renderBitmapString(560, 140, GLUT_BITMAP_TIMES_ROMAN_24, "101983048");
    renderBitmapString(360, 110, GLUT_BITMAP_TIMES_ROMAN_24, "Himanshu");
    renderBitmapString(560, 110, GLUT_BITMAP_TIMES_ROMAN_24, "101983063");
}
